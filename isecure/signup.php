...
<form action="signup.php" method="POST" style="display: flex;
  ...
  <div class="form-group col-md-6">
    ...
    <input type="username" maxlength="11" class="form-control" id="username" name="username" aria-describedby="emailHelp" placeholder="Enter Username" required>
  ...
  <div class="form-group col-md-6">
    ...
    <input type="password" maxlength="11" class="form-control" id="cpassword" name="cpassword" placeholder="Confirm Password"required>
